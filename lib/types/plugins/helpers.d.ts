...
export declare const getPlayerByController: (state: TState, playerController: string) => import("../types").TPlayer | null;
...
export declare const getSquadByID: (state: TState, squadID: string, teamID: string) => import("../types").TSquad | null;
